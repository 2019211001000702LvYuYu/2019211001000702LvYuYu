				...
				<thead>
					...
					<!-- loop_start -->
						...
						<tr>
							...
							<td>${o.orderDate}</td>
						<%
							com.LvYuyu.model.Order o=(com.LvYuyu.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.LvYuyu.dao.UserDao userDao=new com.LvYuyu.dao.UserDao();
						...
						<%
							...
							String paymentType=com.LvYuyu.model.Payment.findByPaymentId(con,n);
							 %>
